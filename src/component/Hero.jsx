...
const Hero = ({setIsSelectOrien}) => {
  const navigate = useNavigate();

  const handleSubmit = () => {
    setIsSelectOrien(true)
    navigate("/select-orien")
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button variant="contained"  size="large" onClick={handleSubmit} style={{marginTop: "40px"}} >Get Started</Button>
      </div>
